# Java Tutorial (Complete Core Java)
...
### 4. **Functions and Methods**
   ...
   - [Practice Exercise 1 : Write programs using functions](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0401.md)
   - [Method overloading](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0402.md)
   - [Practice Exercise 2 : Method Overloading](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0402.md)
   - [Pass by value vs pass by reference](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0403.md)
   - [Practice Exercise 3 : Pass by value vs pass by reference](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0403.md)
   - [Recursion](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0404.md)
   - [Practice Exercise 4 : Program with recursive peocesses](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0404.md)
   - [Scope of variables (local, instance, static)](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0405.md)
   - [Practice Exercise 5 : Snppets and programs on variable types](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0405.md)

### 5. **Object-Oriented Programming (OOP)**
   - [Classes and objects](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0501.md)
   - [Practice Exercise 1 - Classes and Objects](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0501.md)
   - [Constructors and initialization blocks](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0502.md)
   - [Practice Exercise 2 - Constructors and initialization blocks](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0502.md)
   - [`this` keyword](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0503.md)
   - [Practice Exercise 3 - Using `this` keyword](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0503.md)
   - [Inheritance and method overriding](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0504.md)
   - [Practice Exercise 4 - Inheritance and method overriding](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0504.md)
   - [`super` keyword](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0505.md)
   - [Practice Exercise 5 - Using `super` keyword](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0505.md)
   - [Polymorphism (compile-time and runtime)](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0506.md)
   - [Practice Exercise 6 - Polymorphism (compile-time and runtime)](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0506.md)
   - [Encapsulation and access modifiers](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0507.md)
   - [Practice Exercise 7 - Encapsulation and access modifiers](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0507.md)
   - [Abstraction (abstract classes and interfaces)](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0508.md)
   - [Practice Exercise 8 - Abstraction (abstract classes and interfaces)](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0508.md)

### 6. **Arrays and Strings**
   - [One-dimensional and multi-dimensional arrays](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0601.md)
   - [Practice Exercise 1 - One-dimensional and multi-dimensional arrays](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0601.md)
   - [Common array operations](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0602.md)
   - [Practice Exercise 2 - Common array operations](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0602.md)
   ...
   - [Practice Exercise 3 - Strings in Java](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0603.md)
   - [String manipulation methods](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0604.md)
   - [Practice Exercise 4 - String manipulation methods](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0604.md)
   - [Arrays as method parameters](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0605.md)
   - [Practice Exercise 5 - Arrays as method parameters](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0605.md)
...
### 8. **Exception Handling**
   ...
   - [Practice Exercise 1 - Types of exceptions](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0801.md)
   - [Try-catch blocks](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0802.md)
   - [Practice Exercise 2 - Try-catch blocks](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0802.md)
   - [Multiple catch blocks and nested try-catch](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0803.md)
   - [Practice Exercise 3 - Multiple catch blocks and nested try-catch](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0803.md)
   ...
   - [Practice Exercise 4 - Custom exceptions](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0804.md)
...
### 10. **Collections Framework** 
   ...
   - [Practice Exercise 1 - Collections Framework](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1001.md)
   - [List, Set, and Map interfaces](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch1002.md)
   - [Practice Exercise 2 - List, Set, and Map interfaces](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1002.md)
   ...
   - [Practice Exercise 3 - ArrayList, LinkedList, HashSet, TreeSet, HashMap, TreeMap](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1003.md)
   - [Iterators and enhanced for-loop](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch1004.md)
   - [Practice Exercise 4 - Iterators and enhanced for-loop](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1004.md)
   - [Sorting and searching in collections](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch1005.md)
   - [Practice Exercise 5 - Sorting and searching in collections](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1005.md)
   - [Comparable and Comparator interfaces](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch1006.md)
   - [Practice Exercise 6 - Comparable and Comparator interfaces](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1006.md)
...
### 11. **File Handling** 
   ...
   - [Practice Exercise 1 - Reading and writing files using File I/O classes](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1101.md)
   - [Serialization and Deserialization](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch1102.md)
   - [Practice Exercise 2 - Serialization and Deserialization](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1102.md)
   - [FileInputStream, FileOutputStream](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch1103.md)
   - [Practice Exercise 3 - FileInputStream, FileOutputStream Classes](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1103.md)
   - [Handling file exceptions](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch1104.md)
   - [Practice Exercise 4 - Handling file exceptions](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1104.md)
##
