...
### 3. **Control Flow Statements**
   ...
   - [Exercise 1:Basic Decision Manking Programming Exercises](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0301.md) 
   - [Loops (for, while, do-while)](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0303.md)
   - [Exercise 2: Basic Loop Specific Questions](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0302.md)
   - [Break, Continue, and Return statements](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0304.md)
   - [Exercise 3: Loop control specific Questions](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0303.md)
   - [Exercise 4: Patterns using Nested Loops](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0304.md) 
...
### 5. **Object-Oriented Programming (OOP)**
   ...
   - [Exercise 1 - Classes and Objects](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0501.md)
   - [Constructors and initialization blocks](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0502.md)
   - [Exercise 2 - Constructors and initialization blocks](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0502.md)
   - [`this` keyword](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0503.md)
   - [Exercise 3 - Using `this` keyword](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0503.md)
   - [Inheritance and method overriding](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0504.md)
   - [Exercise 4 - Inheritance and method overriding](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0504.md)
   - [`super` keyword](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0505.md)
   - [Exercise 5 - Using `super` keyword](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0505.md)
   - [Polymorphism (compile-time and runtime)](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0506.md)
   - [Exercise 6 - Polymorphism (compile-time and runtime)](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0506.md)
   - [Encapsulation and access modifiers](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0507.md)
   - [Exercise 7 - Encapsulation and access modifiers](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0507.md)
   - [Abstraction (abstract classes and interfaces)](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0508.md)
   - [Exercise 8 - Abstraction (abstract classes and interfaces)](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0508.md)

### 6. **Arrays and Strings**
   - [One-dimensional and multi-dimensional arrays](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0601.md)
   - [Exercise 1 - One-dimensional and multi-dimensional arrays](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0601.md)
   - [Common array operations](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0602.md)
   - [Exercise 2 - Common array operations](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0602.md)
   ...
   - [Exercise 3 - Strings in Java](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0603.md)
   - [String manipulation methods](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0604.md)
   - [Exercise 4 - String manipulation methods](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0604.md)
   - [Arrays as method parameters](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0605.md)
   - [Exercise 5 - Arrays as method parameters](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0605.md)
...
### 8. **Exception Handling**
   ...
   - [Exercise 1 - Types of exceptions](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0801.md)
   - [Try-catch blocks](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0802.md)
   - [Exercise 2 - Try-catch blocks](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0802.md)
   - [Multiple catch blocks and nested try-catch](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch0803.md)
   - [Exercise 3 - Multiple catch blocks and nested try-catch](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0803.md)
   ...
   - [Exercise 4 - Custom exceptions](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex0804.md)
...
### 10. **Collections Framework** 
   ...
   - [Exercise 1 - Collections Framework](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1001.md)
   - [List, Set, and Map interfaces](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch1002.md)
   - [Exercise 2 - List, Set, and Map interfaces](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1002.md)
   ...
   - [Exercise 3 - ArrayList, LinkedList, HashSet, TreeSet, HashMap, TreeMap](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1003.md)
   - [Iterators and enhanced for-loop](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch1004.md)
   - [Exercise 4 - Iterators and enhanced for-loop](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1004.md)
   - [Sorting and searching in collections](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch1005.md)
   - [Exercise 5 - Sorting and searching in collections](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1005.md)
   - [Comparable and Comparator interfaces](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch1006.md)
   - [Exercise 6 - Comparable and Comparator interfaces](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1006.md)
...
### 11. **File Handling** 
   ...
   - [Exercise 1 - Reading and writing files using File I/O classes](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1101.md)
   - [Serialization and Deserialization](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch1102.md)
   - [Exercise 2 - Serialization and Deserialization](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1102.md)
   - [FileInputStream, FileOutputStream](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch1103.md)
   - [Exercise 3 - FileInputStream, FileOutputStream Classes](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1103.md)
   - [Handling file exceptions](https://github.com/fromsantanu/Java-Language/blob/main/pages/ch1104.md)
   - [Exercise 4 - Handling file exceptions](https://github.com/fromsantanu/Java-Language/blob/main/ex/ex1104.md)
##
